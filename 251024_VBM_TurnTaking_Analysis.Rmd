...
d_dyadic <- read.csv('data/d_dyadic.csv')
```
...
Model1_Plot_Child_Conditions <- ggplot() +
  ...
  geom_point(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "steelblue", color = "steelblue", alpha = 0.7, data = filter(C2P_PredictedData, Diagnosis == "Autism Group"), size = 2, position = position_nudge(x = -.22)) + 
  geom_point(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "#FC4E07", color = "#FC4E07", alpha = 0.7, data = filter(C2P_PredictedData, Diagnosis == "Typical Development"), size = 2, position = position_nudge(x = -.18)) + 
  geom_half_violin(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "steelblue", color = "black", alpha = 0.7, data = filter(posteriors, Diagnosis == "Autism Group"), side = "r", position = position_nudge(x = 0), adjust = 0.8) +
  geom_half_violin(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "#FC4E07", color = "black", alpha = 0.7, data = filter(posteriors, Diagnosis == "Typical Development"), side = "r", position = position_nudge(x = 0), adjust = 0.8) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  xlab(' ') +
  coord_flip() +
...
C2P_Change_In_FamiliarityPlot <- ggplot(C2P_PredictedData) +
  ...
  scale_fill_manual(values = c("steelblue", "#FC4E07", "darkgreen")) +
  scale_color_manual(values = c("steelblue", "#FC4E07", "darkgreen")) +
  xlab('Visit') +
...
C2P_PredictedOverlapDataOverall <- ggplot() +
  ...
  geom_boxplot(aes(Condition, Estimate, color = Diagnosis, fill = Diagnosis), filter(posteriors, Diagnosis == "Autism Group"), width = 0.05, color = "black", position = position_nudge(x = -0.30), alpha = 0.9, outliers = F, show.legend = T) +
  geom_boxplot(aes(Condition, Estimate, color = Diagnosis, fill = Diagnosis), filter(posteriors, Diagnosis == "Typical Development"), width = 0.05, color = "black", position = position_nudge(x = -0.10), alpha = 0.9, outliers = F, show.legend = T) +
  geom_point(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "steelblue", color = "steelblue", alpha = 0.7, data = filter(C2P_PredictedOverlapData, Diagnosis == "Autism Group"), size = 2, position = position_nudge(x = -.22)) + 
  geom_point(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "#FC4E07", color = "#FC4E07", alpha = 0.7, data = filter(C2P_PredictedOverlapData, Diagnosis == "Typical Development"), size = 2, position = position_nudge(x = -.18)) + 
  geom_half_violin(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "steelblue", color = "black", alpha = 0.7, data = filter(posteriors, Diagnosis == "Autism Group"), side = "r", position = position_nudge(x = 0), adjust = 0.8) +
  geom_half_violin(aes(Condition, Estimate, fill = Diagnosis, color = Diagnosis), fill = "#FC4E07", color = "black", alpha = 0.7, data = filter(posteriors, Diagnosis == "Typical Development"), side = "r", position = position_nudge(x = 0), adjust = 0.8) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
...
Model2_Plot_Child_Conditions <- ggplot() +
  ...
  geom_half_violin(aes(Parameter, Estimate, fill = Diagnosis, color = Diagnosis), fill = "steelblue", color = "black", alpha = 0.7, data = filter(full_posterior_predictions, Diagnosis == "Autism Group"), side = "r", position = position_nudge(x = 0), adjust = 0.8) +
  geom_half_violin(aes(Parameter, Estimate, fill = Diagnosis, color = Diagnosis), fill = "#FC4E07", color = "black", alpha = 0.7, data = filter(full_posterior_predictions, Diagnosis == "Typical Development"), side = "r", position = position_nudge(x = 0), adjust = 0.8) +
...
predictions <- fitted(OverlappingChild_m2_IndividualDifferences, newdata = newdatanew, allow_new_levels = TRUE)
...
ProportionOverlapsLanguage <- results %>%
  ...
  geom_smooth(aes(x = LanguageS_scaled, y = Probability...11, color = Diagnosis), linewidth = 1.5, se = F, method = "lm", show.legend = FALSE) +
  #facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
...
ProportionOverlapsCognitiveSkills <- results %>%
  ...
  geom_smooth(aes(x = CognitionS_scaled, y = Probability...11, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.8, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = CognitionS_scaled, y = Probability...11, color = Diagnosis), linewidth = 1.5, se = F, method = "lm", show.legend = FALSE) +
  #facet_wrap(~ Condition) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.2)) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
...
ProportionOverlapsMotorSkills <- results %>%
  ...
  geom_smooth(aes(x = MotorS_scaled, y = Probability...11, color = Diagnosis), linewidth = 1.5, se = F, method = "lm", show.legend = FALSE) +
  #facet_wrap(~ Condition) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.2)) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
...
ProportionOverlapsAwarenessSkills <- results %>%
  ...
  geom_smooth(aes(x = AwarenessS_scaled, y = Probability...11, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = AwarenessS_scaled, y = Probability...11, color = Diagnosis), linewidth = 1.5, se = F, method = "lm", show.legend = FALSE) +
  #facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.2)) +
...
ProportionOverlapsMotivationSkills <- results %>%
  ...
  geom_smooth(aes(x = MotivationS_scaled, y = Probability...11, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = MotivationS_scaled, y = Probability...11, color = Diagnosis), linewidth = 1.5, se = F, method = "lm", show.legend = FALSE) +
  #facet_wrap(~ Condition) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.2)) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
...
pred_data <- add_predicted_draws(ChildLatency_m3_pred, 
...
OtherPredictabilityPlot <- OtherPredictabilityPlotData %>%
  ...
  geom_smooth(aes(x = OtherPredictability, y = mean, color = Diagnosis), linewidth = 1.5, method = "lm", se = FALSE, show.legend = FALSE) +
  facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  guides(color = guide_legend(reverse=TRUE, override.aes = list(alpha = 0.5, linewidth = 1))) +
  scale_y_continuous(limits = c(-0.5, 2.5), breaks = c(-2, -1, 0, 1, 2, 4)) +
  #ggtitle('Child Response Latency with Adult Utterance Predictability') +
  ylab('Child Response Latency (sec)') +
  xlab('Predictability of Previous Adult Utterance (Cosine Similarity)') +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size=20), 
        axis.text.x = element_text(size = 20, color = "black"),
        axis.title.x = element_text(size = 20, color = "black"),
...
OwnPredictabilityPlot <- PredictabilityPlotData %>%
  ...
  geom_smooth(aes(x = OwnPredictability, y = mean, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = OwnPredictability, y = mean, color = Diagnosis), linewidth = 1.5, se = FALSE, method = "lm", show.legend = F) +
  facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  scale_y_continuous(limits = c(-0.5, 2.5), breaks = c(-2, -1, 0, 1, 2, 4)) +
  ...
  ylab('Child Response Latency (sec)') +
  xlab('Predictability of Own Utterance (Cosine Similarity)') +
...
OtherPredictabilityPlotAdult <- OtherPredictabilityPlotData %>%
  ggplot() +
  geom_smooth(aes(x = OtherPredictability, y = mean, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.6, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = OtherPredictability, y = mean, color = Diagnosis), linewidth = 1.5, method = "lm", se = FALSE, show.legend = FALSE) +
  ...
  scale_y_continuous(limits = c(-0.5, 2.5), breaks = c(-2, -1, 0, 1, 2, 4)) +
  #ggtitle('Child Response Latency with Adult Utterance Predictability') +
  ylab('Adult Response Latency (sec)') +
  xlab('Predictability of Previous Child Utterance (Cosine Similarity)') +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size=20), 
        axis.text.x = element_text(size = 20, color = "black"),
        axis.title.x = element_text(size = 20, color = "black"),
...
OwnPredictabilityPlotAdult <- PredictabilityPlotData %>%
  ggplot() +
  geom_smooth(aes(x = OwnPredictability, y = mean, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = OwnPredictability, y = mean, color = Diagnosis), linewidth = 1.5, se = FALSE, method = "lm", show.legend = F) +
...
pred_data <- add_predicted_draws(object = m_dyad_coupling_adaptation, 
                ...
                resp = "ChildLatency", value = ".prediction")
...
InterpersonalAdjustmentPlot <- dyadic_predicted_data %>%
  ...
  geom_smooth(aes(x = PrevOtherLatency, y = mean, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = PrevOtherLatency, y = mean, color = Diagnosis),  linewidth = 1.5, method = "lm", se = F, show.legend = F) +
  facet_wrap(~ Condition) +
  #ylim(c(-0)) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  scale_x_continuous(breaks = seq(0, 5, by = 2), limits = c(0, 5)) +
  scale_y_continuous(limits = c(-1, 2.5), breaks = c(-2, -1, 0, 1, 2, 4)) +
  ...
  ylab('Child Response Latency (sec)') +
  xlab('Previous Adult Response Latency (sec)') +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size=20), 
        axis.text.x = element_text(size = 20, color = "black"),
        axis.title.x = element_text(size = 20, color = "black"),
...
SelfAdjustmentPlot <- dyadic_predicted_data %>%
  ...
  geom_smooth(aes(x = PrevSelfLatency, y = mean, color = Diagnosis), linewidth = 1.5, method = "lm", se = F) +
  facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  #ggtitle('Turn-By-Turn Self Adjustment') +
  ylab('Child Response Latency (sec)') +
  xlab('Previous Child Response Latency (sec)') +
  scale_y_continuous(limits = c(-1, 2.5), breaks = c(-2, -1, 0, 1, 2, 4)) +
...
InterpersonalAdjustmentPlotAdult <- dyadic_predicted_data %>%
  ...
  geom_smooth(aes(x = AdultPrevOtherLatency, y = mean, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE, show.legend = T) +
  geom_smooth(aes(x = AdultPrevOtherLatency, y = mean, color = Diagnosis),  linewidth = 1.5, method = "lm", se = F, show.legend = F) +
  facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  scale_x_continuous(breaks = seq(0, 5, by = 2), limits = c(0, 5)) +
...
SelfAdjustmentPlotAdult <- dyadic_predicted_data %>%
  ...
  geom_smooth(aes(x = AdultPrevSelfLatency, y = mean, color = Diagnosis, group = ID), 
              method = "lm", linewidth = 0.15, alpha = 0.4, se = FALSE) +
  geom_smooth(aes(x = AdultPrevSelfLatency, y = mean, color = Diagnosis), linewidth = 1.5, method = "lm", se = F) +
  facet_wrap(~ Condition) +
  scale_fill_manual(values = c("steelblue", "#FC4E07")) +
  scale_color_manual(values = c("steelblue", "#FC4E07")) +
  #ggtitle('Turn-By-Turn Self Adjustment') +
...
Model1_Plot_Child_Gender <- ggplot(C2P_PredictedData, aes(Gender, Estimate, fill = Diagnosis, color = Diagnosis)) +
  ...
  theme_classic() +
  facet_wrap(~ Diagnosis) +
  scale_fill_manual(values = c("steelblue", "#FC4E07", "#f8f2bf")) +
  scale_color_manual(values = c("steelblue", "#FC4E07", "#f8f2bf")) +
...
OtherPredictabilityPlotNoBackChannels
```
...
OwnPredictabilityPlotNoBackChannels
```
...
ggsave(plot = Model1_ChildResponseOverlaps, file = 'figures_for_paper/Fig_2_ChildResponseOverlaps.pdf', height = 17, width = 18)

#Figure 3, main manuscript:
ggsave(plot = Model2_Plot_Child_Conditions, file = 'figures_for_paper/Fig_3_ChildResponseIndividualDifferences.pdf', height = 12, width = 18)
...
ggsave(plot = Model1_Plot_Adult_Conditions, file = 'figures_for_paper/Fig_6_AdultResponseOverlaps.pdf', height = 17, width = 18)

#Figure 7, supplementary materials:
ggsave(plot = Model2_Plot_Adult_Conditions, file = 'figures_for_paper/Fig_7_AdultResponseIndividualDifferences.pdf', height = 12, width = 18)

#Figure 8, supplementary materials:
AdultResponsePredictability <- cowplot::plot_grid(OtherPredictabilityPlotAdult, OwnPredictabilityPlotAdult, nrow = 2)
ggsave(plot = AdultResponsePredictability, file = 'figures_for_paper/Fig_8_AdultResponsePredictability.png', height = 11, width = 12)

#Figure 9, supplementary materials:
SelfAndInterpersonalAdjustmentPlotsAdult <- cowplot::plot_grid(InterpersonalAdjustmentPlotAdult, SelfAdjustmentPlotAdult, nrow = 2)
ggsave(plot = SelfAndInterpersonalAdjustmentPlotsAdult, file = 'figures_for_paper/Fig_9_AdultResponseTurnByTurn.png', height = 11, width = 12)

#Figure 10, supplementary materials:
ggsave(plot = CorrelationMatricesChild, file = 'figures_for_paper/Fig_10_ChildCorrelationMatrices.pdf', height = 15, width = 12)

#Figure 11, supplementary materials:
ggsave(plot = Model1_Plot_Child_ConditionsNoOverlaps, file = 'figures_for_paper/Fig_11_ChildResponseNoOverlaps.pdf', height = 15, width = 12)

#Figure 12, supplementary materials:
ggsave(plot = Model1_Plot_Adult_ConditionsNoOverlaps, file = 'figures_for_paper/Fig_12_AdultResponseNoOverlaps.pdf', height = 15, width = 12)

#Figure 13, supplementary materials:
ggsave(plot = Model2_OverlapsIndividualDifferences, file = 'figures_for_paper/Fig_13_ChildOverlapsIndividualDifferences.pdf', height = 17, width = 18)

#Figure 14, supplementary materials:
ChildResponsePredictabilityNoBackchannels <- cowplot::plot_grid(OtherPredictabilityPlotNoBackChannels, OwnPredictabilityPlotNoBackChannels, nrow = 2)
ggsave(plot = ChildResponsePredictabilityNoBackchannels, file = 'figures_for_paper/Fig_14_ChildResponsePredictabilityNoBackchannels.png', height = 11, width = 12)

#Figure 15, supplementary materials:
ChildResponsePredictabilityMoreThanThreeWords <- cowplot::plot_grid(OtherPredictabilityPlotMoreThanThreeWords, OwnPredictabilityPlotMoreThanThreeWords, nrow = 2)
ggsave(plot = ChildResponsePredictabilityMoreThanThreeWords, file = 'figures_for_paper/Fig_15_ChildResponsePredictabilityMoreThanThreeWords.png', height = 11, width = 12)

#Figure 16, supplementary materials:
ggsave(plot = Model1_Plot_Child_ConditionsSurrogate, file = 'figures_for_paper/Fig_16_ChildSurrogateResponse.pdf', height = 15, width = 12)
...
ggsave(plot = prior_posterior_check_plot, "figures_for_paper/Fig_17_prior_posterior_check_plot.pdf", width = 12, height = 10)
...
ggsave(plot = prior_posterior_check_plot_Adult, "figures_for_paper/Fig_18_prior_posterior_check_plot_Adult.pdf", width = 12, height = 10)

#Figure 19, supplementary materials
ggsave(plot = combined_plot_m1, file = "figures_for_paper/Fig_19_PriorPosterior_m1.pdf", width = 12, height = 15)

#Figure 20, supplementary materials
ggsave(plot = combined_plot_m2, file = "figures_for_paper/Fig_20_PriorPosterior_m2.pdf", width = 12, height = 15)

#Figure 21, supplementary materials
ggsave(plot = combined_plot_m3, file = "figures_for_paper/Fig_21_PriorPosterior_m3.pdf", width = 12, height = 15)

#Figure 22, supplementary materials
combined_plot_m4 <- plot_grid(combined_plot_m4_child, combined_plot_m4_adult, ncol = 2)
ggsave(plot = combined_plot_m4, file = "figures_for_paper/Fig_22_PriorPosterior_m4.pdf", width = 12, height = 15)
...
ggsave(plot = Change_In_FamiliarityPlot, file = 'figures_for_paper/Fig_23_C2P_Change_In_FamiliarityPlot.png', height = 11, width = 12)

#Figure 24, supplementary materials:
ggsave(plot = context_correlation, file = 'figures_for_paper/Fig_24_context_correlation.png', height = 12, width = 20)
